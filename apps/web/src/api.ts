import {
  backupConnectMutation,
  backupDisableMutation,
  backupEnableMutation,
  backupListQuery,
  backupConnectCancelMutation,
  backupRecoveryKeyConfirmMutation,
  backupRecoveryKeyExportMutation,
  backupRecoveryKeyImportMutation,
  ...
  facesMergeMutation,
  facesNameMutation,
  facesPairsDecideMutation,
  facesPairsQuery,
  facesPairsUndoMutation,
  facesPeopleQuery,
  facesPurgeMutation,
  facesReclusterMutation,
  facesStatusQuery,
  ...
  libraryCollectionInfiniteQuery,
  libraryFacetsQuery,
  libraryHideMutation,
  libraryPreviewQuery,
  librarySelectionPreviewQuery,
  libraryTrashMutation,
  libraryUnhideMutation,
  ...
  type ConfigInput,
  type FacesPairsInput,
  type JobInput,
  type LibraryPreviewInput,
  type LibrarySelectionPreviewInput,
...
export const actions = {
  ...
  backupStatus: backupStatusQuery(apiClient),
  backupList: (input: BackupListInput = {}) => backupListQuery(apiClient, input),
  backupRun: backupRunMutation(apiClient),
  backupConnect: backupConnectMutation(apiClient),
  backupTest: backupTestMutation(apiClient),
  backupEnable: backupEnableMutation(apiClient),
  backupDisable: backupDisableMutation(apiClient),
  backupRestore: backupRestoreMutation(apiClient),
  backupRecoveryKeyExport: backupRecoveryKeyExportMutation(apiClient),
  backupRecoveryKeyConfirm: backupRecoveryKeyConfirmMutation(apiClient),
  backupRecoveryKeyImport: backupRecoveryKeyImportMutation(apiClient),
  backupConnectCancel: backupConnectCancelMutation(apiClient),
  ...
  libraryCollectionInfinite: (input: CollectionInput) => libraryCollectionInfiniteQuery(apiClient, input),
  libraryFacets: libraryFacetsQuery(apiClient),
  libraryPreview: (input: LibraryPreviewInput) => libraryPreviewQuery(apiClient, input),
  librarySelectionPreview: (input: LibrarySelectionPreviewInput) => librarySelectionPreviewQuery(apiClient, input),
  libraryHide: libraryHideMutation(apiClient),
  libraryUnhide: libraryUnhideMutation(apiClient),
  libraryTrash: libraryTrashMutation(apiClient),
  ...
  facesPairs: (input: FacesPairsInput = {}) => facesPairsQuery(apiClient, input),
  ...
  facesRecluster: facesReclusterMutation(apiClient),
  facesPairsDecide: facesPairsDecideMutation(apiClient),
  facesPairsUndo: facesPairsUndoMutation(apiClient),
