...
export interface Dictionary {
  ...
  photos: {
    ...
    provenanceLanguageEnglish: string;
    provenanceLanguagePolish: string;
...
export const en: Dictionary = {
  ...
  processing: {
    ...
    stepLabels: {
      ...
      faces_clustering: 'Grouping faces',
  ...
  photos: {
    ...
    provenanceLanguageAuto: 'app language (auto)',
    provenanceLanguageEnglish: 'English',
    provenanceLanguagePolish: 'Polish',
...
export const pl: Dictionary = {
  ...
  catalog: {
    ...
    largeRunWarningBody: (count) => `Znaleziono ${count} ${plPlural(count, 'film', 'filmy', 'filmów')}. Analizę w tej skali lepiej uruchomić z CLI, a początkowe skanowanie może chwilę potrwać.`,
  ...
  details: {
    ...
    gettingStartedSteps: [
      ...
      'Kliknij „Analizuj”, aby przeanalizować pojedyncze filmy',
    ...
    processingIncomplete: 'Analiza nieukończona',
    incompleteHint: 'Poprzednia próba analizy została przerwana. Kliknij przycisk poniżej, aby ją wznowić.',
    processingButton: 'Analizowanie…',
    continueAnalysis: 'Kontynuuj analizę',
    processingFailed: 'Analiza nie powiodła się',
    retrying: 'Ponawianie…',
    ...
    status: {
      ...
      error: 'Podczas analizy wystąpił błąd.',
      pending: 'Gotowe do analizy.',
      framesExtracted: 'Analizę przerwano na etapie wyodrębniania klatek. Kliknij Analizuj, aby kontynuować.',
      audioExtracted: 'Analizę przerwano na etapie wyodrębniania audio. Kliknij Analizuj, aby kontynuować.',
      transcribed: 'Analizę przerwano na etapie transkrypcji. Kliknij Analizuj, aby kontynuować.',
      analyzed: 'Analizę przerwano na etapie analizy. Kliknij Analizuj, aby kontynuować.',
      notTracked: 'Ten film nie został jeszcze przeanalizowany.',
    },
  },
  analysisEmptyState: {
  ...
  processing: {
    ...
    processingFailed: 'Analiza nie powiodła się',
    processingDidNotFinish: 'Analiza nie została ukończona',
    setupIncomplete: 'Konfiguracja analizy jest niepełna. Otwórz Ustawienia albo uruchom Kreator konfiguracji.',
    ...
    driveProcessingFailed: 'Analiza dysku nie powiodła się',
    driveProcessingDidNotFinish: 'Analiza dysku nie została ukończona',
    ...
    stepLabels: {
      ...
      faces_clustering: 'Grupowanie twarzy',
  ...
  cancelDialog: {
    batchTitle: 'Anulować analizę wsadową?',
    singleTitle: 'Anulować analizę?',
    batchBody: 'Czy na pewno chcesz anulować analizę wsadową? Zatrzyma się po zakończeniu analizy bieżącego filmu.',
    batchAlert: 'Bieżący film może pozostać w stanie nieukończonym. Już przeanalizowane filmy zachowają swoje wyniki.',
  ...
  photos: {
    ...
    provenanceProviderApi: 'API',
    provenanceProviderHarness: 'Agent harness',
    provenanceLanguageAuto: 'język aplikacji (auto)',
    provenanceLanguageEnglish: 'angielski',
    provenanceLanguagePolish: 'polski',
