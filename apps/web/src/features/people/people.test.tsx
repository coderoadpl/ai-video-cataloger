  ...
  it('renders populated people with exemplar crops and file counts', async () => {
    stubPeople({
      ...
      people: [
        ...
        person({ personId: 'p2', fallbackIndex: 1, observationCount: 1 }),
      ],
    });
  ...
  it('shows a fallback avatar instead of a bare gray box when a person has no exemplar crop', async () => {
    stubPeople({
      ...
      people: [
        ...
        person({ personId: 'p2', fallbackIndex: 1, observationCount: 1, exemplarCropPath: null }),
      ],
    });
...
describe('PeopleView media chips', () => {
  ...
  it('sorts people by file frequency by default while keeping the original person number', async () => {
    stubPeople({
      ...
      observations: 12,
      people: [
        person({ personId: 'p-first', fallbackIndex: 0, observationCount: 1, videoCount: 1, photoCount: 0, fileCounts: { video: 1, photo: 0 } }),
        person({ personId: 'p-second', fallbackIndex: 1, observationCount: 3, videoCount: 3, photoCount: 0, fileCounts: { video: 3, photo: 0 } }),
        person({ personId: 'p-third', fallbackIndex: 2, observationCount: 6, videoCount: 6, photoCount: 0, fileCounts: { video: 3, photo: 0 } }),
      ],
    });
