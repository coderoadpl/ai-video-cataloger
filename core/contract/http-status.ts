...
export const HTTP_STATUS_BY_ERROR_CODE: Record<ErrorCode, number> = {
  ...
  backup_disabled: 409,
  backup_auth_required: 401,
  backup_destination_error: 502,
  backup_quota_exceeded: 507,
  backup_encryption_failed: 500,
...
export const EXIT_CODE_BY_ERROR_CODE: Record<ErrorCode, number> = {
  ...
  backup_disabled: 47,
  backup_auth_required: 48,
  backup_destination_error: 49,
  backup_quota_exceeded: 50,
  backup_encryption_failed: 51,
  backup_integrity_failed: 52,
  restore_incomplete: 55,
  restore_refused: 53,
...
export const LEGACY_ERROR_CODE_BY_ERROR_CODE: Record<ErrorCode, string> = {
  ...
  library_trash_incomplete: 'LIBRARY_TRASH_INCOMPLETE',
  ...
  backup_auth_required: 'BACKUP_AUTH_REQUIRED',
  backup_destination_error: 'BACKUP_DESTINATION_ERROR',
