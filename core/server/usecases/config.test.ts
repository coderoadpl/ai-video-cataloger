...
describe('config use-cases', () => {
    ...
    expect(result).toMatchObject({
      ...
      value: {
        ...
        sources: {
          ...
          ui_language: 'home',
          backup_enabled: 'home',
          backup_provider: 'home',
          backup_include_optional: 'home',
          backup_keep_last: 'home',
          backup_keep_weekly: 'home',
          backup_folder_id: 'home',
          backup_shared_drive_id: 'home',
          backup_service_account_fingerprint: 'home',
          backup_account_email: 'home',
        },
      },
    });
  });
  ...
  it('lets folder values override home values for every folder-scoped key', async () => {
    ...
    const folderValues = {
      ...
      backup_folder_id: 'ignored-folder-id',
      backup_shared_drive_id: 'ignored-drive-id',
      backup_service_account_fingerprint: 'ignored-fingerprint',
      backup_account_email: 'ignored@example.com',
    } as const;
    for (const key of CONFIG_KEYS) {
