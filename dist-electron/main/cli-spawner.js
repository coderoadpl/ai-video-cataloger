 ...
 */
export function spawnCLI(args, options, onStdout, onStderr, onExit) {
 ...
 * @returns Process handle with kill capability
 */
export function spawnCLIWithJson(args, options, onJson, onRawOutput, onStderr, onExit) {
    // Ensure --json flag is included
    const fullArgs = args.includes('--json') ? args : ['--json', ...args];
    return spawnCLI(fullArgs, { ...options, json: true }, (line) => {
...
//# sourceMappingURL=cli-spawner.js.map